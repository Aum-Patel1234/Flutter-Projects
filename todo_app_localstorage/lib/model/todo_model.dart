...
class TodoModel {
  ...
  factory TodoModel.fromMap(Map<String,dynamic> map) {
    return TodoModel(
      ...
      completedAt: map['completedAt'] != null
          ...
          : null,
      toBeCompletedByDate: DateTime.fromMillisecondsSinceEpoch(int.parse(map['toBeCompletedByDate'])),
      toBeCompletedByTime: TimeOfDay(
          hour: int.parse(map['toBeCompletedByTime'].split(':')[0]),
          minute: int.parse(map['toBeCompletedByTime'].split(':')[1]),),
    );
  }
  ...
  Map<String,dynamic> toMap(){
    return {
      ...
      'toBeCompletedByDate' : toBeCompletedByDate.millisecondsSinceEpoch.toString(),
...
'CREATE TABLE $tableName (
  ...
  updatedAt INTEGER,
  completedAt INTEGER,
  toBeCompletedByDate TEXT NOT NULL,
