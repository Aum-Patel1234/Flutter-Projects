        ...
        children: [
          UserAccountsDrawerHeader(
            ...
            currentAccountPicture: CircleAvatar(
              ...
              child: Text(
                context.read<AuthBloc>().state.user?.username ?? 'U',
                style: TextStyle(color: (Theme.of(context).brightness == Brightness.dark) ? const Color.fromARGB(255, 65, 100, 117) : Colors.black, fontSize: 40),
              ),
            ),
          ),
          Expanded(
